...
public class ProjectSupportBonusDaoImpl extends GenericDaoImpl<ProjectSupportBonus, Long> implements ProjectSupportBonusDao {
	...
	private ProjectSupportBonusVo transProjectSupportBonus(Object[] o) {
		...
		vo.setAcceptanceRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[9]), 2));
		vo.setPlanDays(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[10]), 2));
		vo.setRealDays(StringUtil.nullToInteger(o[11]));
		vo.setBonusAdjustRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[12]), 2));
		vo.setBonusRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[13]), 2));
		vo.setBonusAcceptanceRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[14]), 2));
		vo.setContractAmount(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[15]), 2));
		vo.setTaxRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[16]), 2));
		vo.setBonusBasis(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[17]), 2));
