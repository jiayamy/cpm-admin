...
public class ProjectOverallDaoImpl extends GenericDaoImpl<ProjectOverall, Long> implements ProjectOverallDao  {
	...
	private ProjectOverallVo transProjectOverallVo(Object[] o) {
		...
		vo.setContractAmount(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[3]), 2));
		vo.setTaxRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[4]), 2));
		vo.setIdentifiableIncome(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[5]), 2));
		vo.setContractFinishRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[6]), 2));
		vo.setAcceptanceIncome(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[7]), 2));
		vo.setReceiveTotal(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[8]), 2));
		vo.setReceivableAccount(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[9]), 2));
		vo.setShareCost(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[10]), 2));
		vo.setThirdPartyPurchase(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[11]), 2));
		vo.setInternalPurchase(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[12]), 2));
		vo.setBonus(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[13]), 2));
		vo.setGrossProfit(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[14]), 2));
		vo.setGrossProfitRate(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[15]), 2));
		...
		vo.setImplementationCost(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[19]), 2));
		vo.setAcademicCost(StringUtil.getScaleDouble(StringUtil.nullToDouble(o[20]), 2));
