 ...
 *项目人员工时
 */
public class ProjectUserInputVo {
	...
	public ProjectUserInputVo() {
	}
	public ProjectUserInputVo(String projectSerialNum,String projectName, Double realInput, Double acceptInput, Double extraInput,
			Double acceptExtraInput) {
	...
	public String toString() {
		return "ProjectUserInputVo [projectSerialNum=" + projectSerialNum + ", projectName=" + projectName
