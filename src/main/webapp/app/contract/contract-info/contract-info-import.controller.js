(function() {
    ...
    ContractInfoImportController.$inject = ['$state','$rootScope', '$scope','ContractInfo','Upload','previousState','AlertService','$http','$timeout','CpmUtil','$translate'];

    function ContractInfoImportController ($state,$rootScope, $scope, ContractInfo, Upload,previousState,AlertService,$http,$timeout,CpmUtil,$translate) {
        var vm = this;
        ...
        //上传文件
        $scope.handlingUrl = "api/contract-infos/uploadExcel";//处理文件的URL
        $scope.type = '3';//上传文件类型
