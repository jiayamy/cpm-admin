(function() {
    ...
    ContractCostImportController.$inject = ['$state','$rootScope', '$scope','Upload','previousState','AlertService','$http','$timeout','CpmUtil','$translate'];

    function ContractCostImportController ($state,$rootScope, $scope, Upload,previousState,AlertService,$http,$timeout,CpmUtil,$translate) {
        var vm = this;
        ...
        //上传文件
        $scope.handlingUrl = "api/contract-costs/uploadExcel";//处理文件的URL
        $scope.type = '5';//上传文件类型
