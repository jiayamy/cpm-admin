(function() {
    ...
    angular
        .module('cpmApp')
        .controller('ShareCostRateController', ShareCostRateController);

    ShareCostRateController.$inject = ['$scope', '$state', 'ShareCostRate','DeptType',  'ParseLinks', 'AlertService', 'paginationConstants', 'pagingParams'];

    function ShareCostRateController ($scope, $state, ShareCostRate,DeptType, ParseLinks, AlertService, paginationConstants, pagingParams) {
        var vm = this;
        ...
        function loadAll () {
            ...
            function onSuccess(data, headers) {
                ...
                vm.shareCostRates = handleData(data);
        ...
        function search() {
            ...
            vm.links = null;
            vm.page = 1;
            vm.predicate = 'wscr.contractType';
            vm.reverse = false;
            vm.haveSearch = true;
            vm.transition();
        }
